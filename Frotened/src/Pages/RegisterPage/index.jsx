    ...
    <div className="h-screen w-full">
      {!showOutlet && (
        <div className="flex h-screen flex-col sm:flex-row">
          <div className="w-full sm:w-1/2 bg-gray-200 flex items-center justify-center py-10">
            <div className="text-center animate__animated animate__fadeInLeft">
              ...
              <p className="text-lg sm:text-lg">"We're thrilled to have you with us! Dive into our features, engage in groundbreaking discussions, and start your journey today!"
