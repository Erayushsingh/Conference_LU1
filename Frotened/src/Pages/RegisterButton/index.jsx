...
//   return (
//     <div className='md:h-screen overflow-y-auto w-full flex'>
//       <div className="bg-white p-0 z-50 transition-opacity duration-500 ease-in-out opacity-100 flex">

//         <div className="w-1/2 bg-gray-100 md:block hidden fade-in animate__animated animate__fadeInLeft">
//           <img src={Logo} alt="Logo" className="w-full h-full object-cover" />
//         </div>


//         <div className="md:w-1/2 w-[100%] p-10 fade-in animate__animated animate__fadeInRight">
