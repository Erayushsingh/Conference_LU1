    ...
    <>
      ...
      <div className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="text-lg md:text-xl text-gray-700 space-y-6">
            <p>
              1. Participants are required to register by paying the applicable registration fees.
            </p>
            <p>
              2. Please log in using your registered credentials to submit your abstract.
            </p>
            <p>
              3. Complete the abstract submission form with the necessary details.
            </p>

            <p className="text-red-700 font-semibold">
              <strong>Important Note:</strong> Please ensure that all information provided during registration is accurate and truthful. Any discrepancies or false information may result in the cancellation of your registration and restricted access to our services. We highly recommend reviewing your details before submission to avoid any issues.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="text-lg md:text-xl text-gray-700 space-y-6">
            ...
            <p>
              <strong className='text-red-400'>Please attach the abstract file drive link in the specified format to the abstract submission form and submit your abstract.</strong>
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="py-12 bg-gray-50">
        <div className="container mx-auto px-4 space-y-2">
          <h2 className="text-3xl font-extrabold text-center text-black mb-8">Full Paper Submission</h2>
          <h2 className="text-lg font-bold  text-black mb-8">If you wish to submit the full paper, mail us at: <a href="mailto:raashee.foet@gmail.com" class="text-blue-500">raashee.foet@gmail.com</a></h2>
          <p className='text-lg  '>
            Please mention the following details in the subject line of the email:
