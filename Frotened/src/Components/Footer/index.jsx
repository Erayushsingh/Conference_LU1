...
//   return (
//     <>
//       <div className='bg-gray-900 text-white flex justify-between items-start p-6'>

//         {/* Racchi Section with Social Media Icons */}
//         <div className='flex-shrink-0 w-1/3 flex flex-col items-center relative'>
