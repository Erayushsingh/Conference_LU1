      ...
      <div className="md:py-12">
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-lg p-8">
            ...
            <p className="text-lg text-gray-700 mb-6 md:text-xl md:leading-8">
            ...
            <p className="text-lg text-gray-700 md:text-xl md:leading-8 ">
      ...
      <div className="md:pb-10">
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-lg p-8">
            ...
            <ul className="list-inside space-y-4 text-lg text-gray-800  md:text-xl md:leading-8">
              <li className="flex items-center">
                <span className="w-3 h-3 mr-4 bg-indigo-500 rounded-full  md:text-xl md:leading-8"></span>
      ...
      <div className="flex items-center flex-col-reverse md:pl-40 md:flex-row">
        <div className="bg-white rounded-lg  shadow-lg p-6 my-8 w-full sm:w-4/5 lg:w-[80%] xl:w-1/2 mx-auto">
          ...
          <ul className="list-inside space-y-2 text-lg sm:text-xl w-full text-gray-700 text-center">
            <li className="font-semibold text-red-600 md:mb-3  md:text-xl md:leading-8">
              Prof. V. P. Singh, Department of EML, University of Lucknow
            </li>
            <li className="font-semibold text-indigo-600 md:mb-3  md:text-xl md:leading-8">
