...
//         <div className="flex justify-center items-center animate-zoom-out-in">
//           <p className="text-2xl font-bold  "> Registration Opened for RASHEE-2025 | Registration Close 25 Dec 2024 | </p>
//           <button
//             onClick={handleRegisterClick}
//             className="ml-5  px-6 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-700"
//           >
//             Register Now
//           </button>
//         </div>
...
//         <div className="flex justify-center items-center animate-marquee ">
//           <p className="text-3xl font-extrabold text-white">
//             University of Lucknow | Department of Applied Science & Humanities
//           </p>
//         </div>
//       </div>
...
{/* <div className="bg-white rounded-lg  p-6 my-8 w-[80%] mx-auto">
...
{/* <div className="bg-white rounded-lg shadow-lg p-6 my-8 w-4/5 mx-auto">
...
{/* Keynote and Invited Talks Section */ }
{/* <div className="bg-white rounded-lg shadow-lg p-6 my-8 w-4/5 mx-auto">
  <h3 className="text-2xl font-bold text-black mb-4 text-center">Keynote and Invited Talks</h3>
  <ul className="list-inside space-y-2 text-lg text-gray-700 text-center">
...
//     {/* Patron Container */}
//     <div className="flex flex-col items-center p-4 bg-yellow-50 rounded-lg w-1/3">
...
//     {/* Convener Container */}
//     <div className="bg-yellow-50 rounded-lg shadow-lg p-6 w-1/3 flex flex-col items-center">
...
//     <div className="bg-green-50 rounded-lg shadow-lg p-6 w-1/3 flex flex-col items-center">
