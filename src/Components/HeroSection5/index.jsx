    ...
    <>
        ...
        <div className='flex justify-center w-full mb-28'>
            <div className='w-[80%]'>
                ...
                <span>The publishers that AMPS works with include Routledge Taylor & Francis, UCL Press, Cambridge Scholars Publishing,
                   Vernon Press,<p> Libri Publishing and Intellect Books.</p>
                </span>
                <p className='mt-5'>Conference outputs include the AMPS Proceedings Series, ISSN 2398-9467; Special Issue Publications of the academic journal Architecture_MPS ISSN 2020-9006; 
        ...
        <div className='w-full flex justify-center'>
            <div className='w-[80%] '>
                ...
                <div className='text-black mb-28'>
                    <button className='p-3 pl-9 border-2 border-black mr-7 pr-9 bg-white'>Abstracts</button>
                    <button className='p-3 pl-9 border-2 border-black mr-7 pr-9 bg-white'>Register</button>
                </div>
            </div>
        </div>
    </>
